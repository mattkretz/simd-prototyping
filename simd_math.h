...
namespace SIMD_NSPC
{
    ...
    */
    ...
    template <typename... _Ts>
      concept __math_floating_point
        = (requires(_Ts __x) { { basic_vec(__x) } -> std::floating_point; } or ...)
        = std::floating_point<typename __deduced_simd<_Ts>::value_type>
            and (std::convertible_to<_Ts, __deduced_simd<_Ts...>> and ...);
  ...
  template <typename _V0, typename _V1, auto = __detail::__build_flags()>
    ...
    constexpr __detail::__deduced_simd<_V0, _V1>
    hypot(const _V0& __xx, const _V1& __yy)
    {
      using _Vp = __detail::__deduced_simd<_V0, _V1>;
      const _Vp& __x = __xx;
      const _Vp& __y = __yy;
  ...
  template <typename _V0, typename _V1, typename _V2, auto = __detail::__build_flags()>
    ...
    constexpr __detail::__deduced_simd<_V0, _V1, _V2>
    hypot(const _V0& __xx, const _V1& __yy, const _V2& __zz)
    {
      using _Vp = __detail::__deduced_simd<_V0, _V1, _V2>;
      const _Vp& __x = __xx;
      const _Vp& __y = __yy;
      const _Vp& __z = __zz;
